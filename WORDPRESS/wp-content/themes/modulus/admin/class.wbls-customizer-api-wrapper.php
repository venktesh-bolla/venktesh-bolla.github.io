...
if( ! class_exists('Wbls_Customizer_API_Wrapper') ) {
	class Wbls_Customizer_API_Wrapper {
		...
		public function enqueue_scripts() {
			...
			wp_localize_script( 'customizer-js', 'modulus_upgrade', array( 'message' => __( 'Get Pro for just $39', 'modulus' ), 'docs' => __( 'Documentation', 'modulus' ), 'demo' => __( 'Demo', 'modulus' ), 'support' => __( 'Ask a Question', 'modulus' ) ) );
		}
