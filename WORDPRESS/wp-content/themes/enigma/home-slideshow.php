<!-- Carousel
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
	  ...
	  <?php $wl_theme_options = weblizar_get_options();
		$ImageUrl1 = WL_TEMPLATE_DIR_URI ."/images/ebd_images/tux_class.jpg";
		$ImageUrl2 = WL_TEMPLATE_DIR_URI ."/images/ebd_images/arm.jpg";
		$ImageUrl3 = WL_TEMPLATE_DIR_URI ."/images/ebd_images/qualcomm.jpg";  ?>
