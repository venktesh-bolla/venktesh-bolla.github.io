...
class Bistro_Menu_A extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'bistro_menu_a', 'description' => __( "Show menu items from a particular tag", "bistro") );
		parent::__construct('menu-type-a', __( "Bistro: Menu Type A", "bistro"), $widget_ops);
		$this->alt_option_name = 'widget_menu_a';
...
?>
		...
		<div class="menu-entry menu-type-a col-md-3 col-sm-4 col-xs-6">
			<div class="type-a-inner">
